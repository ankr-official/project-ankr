      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <Section number="2" title="서비스 내용">
          ...
          <ul className="list-disc list-inside space-y-1 mt-2">
            ...
            <li>
              내 활동 페이지 생성 및 공개 공유 — 로그인 이용자는 고유 활동 주소
              (예: ankr.kr/@handle)와 닉네임을 설정하고, 활동 내역을 공개로
              전환하여 링크를 통해 누구나 열람 가능하도록 공유할 수 있습니다.
            </li>
          </ul>
          <p className="mt-2">
        ...
        <Section number="3" title="회원가입 및 계정">
          ...
          <ul className="list-disc list-inside space-y-1 mt-2">
            ...
            <li>
              로그인 이용자는 내 활동 페이지에서 고유 활동 주소(handle)와
              닉네임을 설정할 수 있습니다. 활동 주소는 서비스 전체에서 유일해야
              하며, 한 번 설정 후 변경은 가능하지만 이전 주소는 즉시 해제됩니다.
            </li>
            <li>
              이용자는 활동 내역(관심 행사·다녀온 행사)의 공개 여부를 직접
              설정할 수 있으며, 공개로 설정한 경우 활동 주소 링크를 통해 누구나
              해당 내역을 열람할 수 있습니다. 이용자는 이벤트별로 개별 공개·비공개
              설정도 가능합니다.
            </li>
            <li>
              이용자는 서비스 내 설정에서 닉네임 삭제, 활동 페이지 삭제(활동
              주소·공개 데이터 포함), 행사 기록 전체 삭제를 직접 수행할 수
              있습니다.
            </li>
            <li>
