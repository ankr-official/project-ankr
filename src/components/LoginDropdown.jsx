...
export default function LoginDropdown({ onClose, position = "bottom", align = "right" }) {
  ...
  return (
    <div className={`absolute ${alignClass} ${positionClass} z-50 w-72 rounded-xl bg-white dark:bg-gray-900 border border-gray-200/70 dark:border-gray-800 shadow-xl p-4`}>
      <div className="flex items-center gap-2 mb-3">
        <img src="/favicon.svg" alt="ANKR 로고" className="w-5 h-5" />
        <span className="text-sm font-semibold text-gray-900 dark:text-white">ANKR.KR 로그인</span>
      </div>
      ...
      <div className="flex justify-center">
        <GoogleLogin
          onSuccess={(credentialResponse) => {
            ...
            signInWithCredential(auth, credential).then(() => onClose());
          }}
          onError={() => {
