...
const inputClass =
  "w-full px-3 py-2 rounded-lg text-sm bg-white dark:bg-gray-800 border border-gray-300/70 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-colors";
...
export default function EventEditModal({
  ...
  const [form, setForm] = useState(() => ({
    ...
    schedule:
      isoToLocal(event?.schedule) || new Date().toISOString().slice(0, 10),
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-2xl my-4 sm:my-0 rounded-2xl bg-white dark:bg-gray-900 border border-gray-200/70 dark:border-gray-800 shadow-2xl"
        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                onBlur={() => setTimeout(() => setEventNameOpen(false), 150)}
              ...
              {eventNameOpen &&
                (() => {
                  const q = form.event_name?.toLowerCase() ?? "";
                  const filtered = eventNameSuggestions.filter(
                    (n) => n.toLowerCase().includes(q) && n !== form.event_name,
                  );
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5" ref={locationRef}>
              ...
              <div className="relative">
                <input
                  type="text"
                  value={locationTbd ? "장소 미정" : form.location}
                ...
                {locationOpen &&
                  (() => {
                    ...
                    const filtered = locationSuggestions.filter(
                      (l) => l.toLowerCase().includes(q) && l !== form.location,
                    );
                    return filtered.length > 0 ? (
              ...
              <label className="inline-flex items-center gap-2 mt-1.5 cursor-pointer select-none">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (e.target.checked) set("location", "장소 미정");
                    else set("location", "");
                  }}
          ...
          <div className="space-y-1.5">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              시간 정보 <span className="text-xs text-gray-400">(선택)</span>
            </label>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) => set("time_entrance", e.target.value)}
                  className={inputClass}
                />
              </div>
              <div className="space-y-1">
          ...
          <div className="space-y-1.5">
            ...
            <div className="rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200/70 dark:border-gray-700/70 p-3 space-y-3">
              ...
              {/* 커스텀 장르 태그 */}
              {form.genre?.filter((g) => !GENRES.includes(g)).length > 0 && (
