...
export const Default = () => (
  <div style={{ padding: 16, maxWidth: 480, display: 'flex', flexDirection: 'column', gap: 8 }}>
    <EventCard
...
export const DarkMode = () => (
  <div className="dark" style={{ background: '#1f2937', padding: 16, maxWidth: 480, display: 'flex', flexDirection: 'column', gap: 8 }}>
    <EventCard
